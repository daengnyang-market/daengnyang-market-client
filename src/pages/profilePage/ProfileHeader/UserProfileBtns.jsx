...
//   const handleGoChat = () => {
//     getMyPost();
//     console.log('데이터확인', profileUserAccountname, userAccountname);
//     setIsValidate(getUserContent(opponentData, profileUserAccountname, userAccountname));
//     console.log('불린값:', isValidate);
//     if (isValidate === true) {
//       createChatroom();
//       setIsValidate(false);
...
//     if ((profileUserAccountname, userAccountname)) {
//       for (let i = 0; i < opponentData.length; i++) {
//         console.log('어포넌트데이터', opponentData[i].content);
//         console.log('프로필데이터', profileUserAccountname);
//         console.log('어카운트데이터', userAccountname);
//         console.log(opponentData[i].content === `${profileUserAccountname},${userAccountname}`);
//         console.log(opponentData[i].content === `${userAccountname},${profileUserAccountname}`);
//         if (
...
//     if (opponentData) {
//       setIsValidate(getUserContent(opponentData, profileUserAccountname, userAccountname));
//       console.log('opponentData받아옴', isValidate);
//     }
//   }, [opponentData]);
